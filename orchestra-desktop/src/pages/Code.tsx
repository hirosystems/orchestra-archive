...
import './App.scss';
import { Box, BranchName, SideNav, Text, FilteredSearch, CounterLabel, Dropdown, TextInput } from '@primer/react'
...
function Data() {
  return (
    <Box display="flex">
      <Box p={3} borderColor="border.default" borderWidth={0} borderStyle="solid">
      </Box>
      <Box flexGrow={1} p={3}>
