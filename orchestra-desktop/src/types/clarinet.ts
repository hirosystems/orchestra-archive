...
export enum StacksTransactionEventType {
  ...
  StacksNFTTransferEvent = "Transfer",
  StacksNFTMintEvent = "Mint",
  StacksNFTBurnEvent = "Burn",
  StacksFTTransferEvent = "Transfer",
  StacksFTMintEvent = "Mint",
  StacksFTBurnEvent = "Burn",
  StacksDataVarSetEvent = "DataVarSetEvent",
  StacksDataMapInsertEvent = "Insert",
  StacksDataMapUpdateEvent = "Update",
  StacksDataMapDeleteEvent = "Delete",
